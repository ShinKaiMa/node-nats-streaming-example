...
let subscriber = nats.connect('test-crawler-cluster', 'test-durable-subscriber-2', { url: 'nats://localhost:4222' });

subscriber.on('connect', () => {
    console.log("test-durable-subscriber-2 has connected to nats");
