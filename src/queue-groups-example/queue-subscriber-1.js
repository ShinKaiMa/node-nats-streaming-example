...
let subscriber = nats.connect('test-crawler-cluster', 'test-queue-groups-subscriber-1', { url: 'nats://localhost:4222' });

subscriber.on('connect', () => {
    console.log("test-queue-groups-subscriber-1 has connected to nats");
